...
$acc_username = "itsmichael";
$acc_password = "michael123";
$acc_fullname = "Michael Permejo";
$acc_address = "Mansiwat Boac, Marinduque";
...
if (isset($_REQUEST['login_button']) == true){
	//Get the username and password from the form and compare to the predefined and password
